...
<html lang="en">
 <head>
    ...
    <meta name="description" content="intrebari matematica,aplicatii matematica,intrebari matematica pentru copii,tabla inmultirii, adunare,scadere, tabla impartirii">
    <title>Inmultire App</title>
 ...
 <body>
   ...
   <nav class="topnav" id="myTopnav">
      ...
      <a href="javascript:void(0);" class="apps" id="menu" onclick="forMenu()">
    ...
    <div class="objectMulty">
        ...
        <div class="container" id="containerMulty">
          <span class="tipRaspuns" id="tipRaspunsMultiply"></span>
          <span class="scor" id="scorMulty"></span>
          <div class="intrebarea" id="intrebareaMulty"></div>
          <input type="text" class="intrare" id="intrareMulty" size="10" placeholder="Raspuns" autofocus>
          <div id="appGen" class="no1 ">   
            <div id="keys">
              ...
              <button   class="taste buton" id="butonMulty" >Enter</button>
