...
<body>
    ...
    <nav class="topnav" id="myTopnav">
      ...
      <div class="objectMulty">
        <div class="container" id="containerSum">
          <span class="tipRaspuns" id="tipRaspunsSum"></span>
          <span class="scor" id="scorSum"></span>
          <div   class="intrebarea"   id="intrebareaSum"></div>
          <input type="text"   class="intrare" id="intrareSum" size="10" placeholder="Raspuns" autofocus>
          ...
          <div id="keys">
            ...
            <button   class="taste buton" id="butonSum" >Enter</button>
