...
<html lang="en">
 ...
 <body>
   ...
   <div class="objectMulty">
      <div  class="container" id="containerDivision">
         <span class="tipRaspuns"  id="tipRaspunsDivision"></span>
         <span class="scor" id="scorDivision"></span>
         <div  class="intrebarea" id="intrebareaDivision"></div>
         <input type="text" class="intrare" id="intrareDivision" size="10" placeholder="Raspuns" autofocus >
         <div id="appGen" class="no1 ">   
            <div id="keys">
              ...
              <button   class="taste buton" id="butonDivision" >Enter</button>
 ...
 <script src="impartire.js"></script>
 </body>
</html>